...
export default function Index() {
  ...
  return (
    <div className="text-white">
      <div className="py-4 grid grid-cols-3 grid-rows-1 gap-2 bg-[#1C1C1E] text-[17px]">
        <div className="flex">
      ...
      <div className="mb-8">
        <div className="mt-6 mb-2 grid grid-cols-[20%,80%] grid-rows-2 flex items-center bg-[#1C1C1D] h-[105.48px] text-[17px]">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Name"
              className="ml-3 bg-[#1C1C1D] placeholder-[#545458A6] focus:outline-none"
            />
        ...
        <p className="text-[#8E8E93] ml-4 text-[14px]">
      ...
      <div className="mb-8">
        <div className="bg-[#1C1C1D] h-[50.29px] flex items-center mb-2">
          <input
            ...
            className="ml-4 bg-[#1C1C1D] placeholder-[#545458A6] focus:outline-none"
          />
        </div>
      ...
      <button
        className="bg-[#1C1C1D] h-[51px] text-[17px] flex items-center justify-center mb-6 w-full"
        onClick={handleButtonClick}
      >
        Done
      </button>

      <div className="bg-[#1C1C1D] text-[#EB5545] text-[17px] h-[51px] flex items-center justify-center">
        Log Out
      </div>
    </div>
  );
